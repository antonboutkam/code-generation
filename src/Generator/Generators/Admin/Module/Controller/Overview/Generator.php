...
final class Generator
{
    ...
    function create(Table $oTable)
    {
        ...
        file_put_contents($this->getBaseFileName($oTable), '<?php' . PHP_EOL . $sBaseOverviewController);
        ...
        if(!file_exists($this->getFileName($oTable)))
        {
            ...
            file_put_contents($this->getFileName($oTable), '<?php' . PHP_EOL . $sOverviewController);
        }
        else
        {
